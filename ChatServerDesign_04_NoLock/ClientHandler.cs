	...
	public class ClientHandler
	{
        ...
        private void doDialog()
        {
            try
            {
                ...
                chatService.TilmeldBroardcasting(this);      // tilføj klientens til chat-service broadcast tjeneste
            ...
            {
                chatService.AfmeldBroardcasting(this);      // fjern klienten fra chat-service broadcast tjeneste
            }
        }
