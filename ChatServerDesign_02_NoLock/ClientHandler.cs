...
namespace ChatServerDesign_03_NoLock
{
	public class ClientHandler
	{
        ...
        private Server chatService;    // Chat funktioner og samtidig monitor for fælles resource

        public ClientHandler(Socket clientSocket, Server chatService)
		{
        ...
        private void doDialog()
        {
            try
            {
                ...
                chatService.TilmeldBroardcasting(writer);      // tilføj klientens streamwriter chat-service broadcast tjeneste
            ...
            {
                chatService.AfmeldBroardcasting(writer);      // fjern klientens streamwriter chat-service broadcast tjeneste
            }
        }
